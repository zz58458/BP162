...
#Region "单段直线插补"
    ...
    Public Overridable Function LineMultiCoorH(ByVal AnxisNum As Integer, ByRef UAnxi() As UShort, ByRef Position() As Integer, ByVal PosiMode As Integer) As Boolean
