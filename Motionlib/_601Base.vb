Public Class _601Base

    Inherits BaseFunction

    Private mMust As New Threading.Mutex(False)
    Dim ip() As String = {"192.168.0.100", "192.168.0.110"}
    Dim port As Integer = 2000
    Dim cardCnt As Integer
    Dim Mt As List(Of DMC601Mng) = New List(Of DMC601Mng)
    'Public Sub New(ByVal ipAddres As String, ByVal portNum As Integer)
    '    cardCnt = 2
    '    ip = ipAddres
    '    port = portNum
    '    mMust = New Threading.Mutex
    '    Mt = New DMC601Mng
    'End Sub
    Public Sub New()
        cardCnt = 2
        mMust = New Threading.Mutex
        For i As Short = 1 To ip.Length
            Dim tt As New DMC601Mng()
            Mt.Add(tt)
        Next
...
#Region "底层函数"
    Public Overrides Function Init() As Int16
        mMust.WaitOne()
        Try
            For i As Short = 0 To ip.Length - 1
                Mt(i).Init(ip(i), port)
            Next
    ...
    ''' <param name="outmode">脉冲输出方式选择：1-脉冲+方向，2-正负脉冲</param>
    ''' <remarks></remarks>
    Public Overrides Sub PulseOutmode(ByVal axis As Int16, ByVal outmode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_pulse_outmode(axis Mod 6, outmode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SD(ByVal axis As Int16, ByVal enable As Int16, ByVal sd_logic As Int16, ByVal sd_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            'd2410_config_SD_PIN(axis mod 6, enable, sd_logic, sd_logic)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub PCS(ByVal axis As Int16, ByVal enable As Int16, ByVal pcs_logic As Int16)
        ...
        mMust.WaitOne()
        Try
            'd2410_config_PCS_PIN(axis mod 6, enable, pcs_logic)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub INP(ByVal axis As Int16, ByVal enable As Int16, ByVal inp_logic As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_INP_PIN(axis Mod 6, enable, inp_logic)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ERC(ByVal axis As Int16, ByVal enable As Int16, ByVal erc_logic As Int16, ByVal erc_width As Int16, ByVal erc_off_time As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_ERC_PIN(axis Mod 6, enable, erc_logic, erc_width, erc_off_time)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ALM(ByVal axis As Int16, ByVal alm_logic As Int16, ByVal alm_action As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_ALM_PIN(axis Mod 6, alm_logic, alm_action)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ELMODE(ByVal axis As Int16, ByVal el_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_EL_MODE(axis Mod 6, el_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetHome(ByVal axis As Int16, ByVal org_logic As Int16, ByVal filter As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_HOME_pin_logic(axis Mod 6, org_logic, filter)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function ReadSEVON(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).read_SEVON_PIN(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub writeSEVON(ByVal axis As Int16, ByVal on_off As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).write_SEVON_PIN(axis Mod 6, on_off)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub WriteERC(ByVal axis As Int16, ByVal sel As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).write_ERC_PIN(axis Mod 6, sel)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function ReadRDY(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).read_RDY_PIN(axis Mod 6)
        Catch ex As Exception
            Return -1
        Finally
            mMust.ReleaseMutex()
    ...
    Public Overrides Function ReadInbit(ByVal cardno As Int16, ByVal BitNo As Int16) As Int32
        ...
        Try
            If cardno >= 2 Then
                Return Mt(cardno).read_exInbit(cardno, BitNo)
            Else
                Return Mt(cardno).read_inbit(BitNo)
            End If
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
    ...
    Public Overrides Sub WriteOutbit(ByVal cardno As Int16, ByVal BitNo As Int16, ByVal on_off As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).write_outbit(BitNo, on_off)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function ReadOutbit(ByVal cardno As Int16, ByVal BitNo As Int16) As Int32
        ...
        Try
            If cardno >= 2 Then
                Return Mt(cardno).read_exOutbit(cardno, BitNo)
            Else
                Return Mt(cardno).read_outbit(BitNo)
            End If
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
    ...
    Public Overrides Function ReadInport(ByVal card As Int16) As Int32
        ...
        Try
            If card >= 2 Then
                Return Mt(card).read_exInport(card)
            Else
                Return Mt(card).read_inport()
            End If
    ...
    Public Overrides Function ReadOutport(ByVal card As Int16) As Int32
        ...
        Try
            If card >= 2 Then
                Return Mt(card).read_exoutport(card)
            Else
                Return Mt(card).read_outport()
            End If
    ...
    Public Overrides Sub WriteOutport(ByVal cardno As Int16, ByVal Port_Value As Int32)
        ...
        Try
            If cardno >= 2 Then
                Mt(cardno).write_exoutport(cardno, Port_Value)
            Else
                Mt(cardno).write_outport(Port_Value)
            End If
    ...
    Public Overrides Sub HomeMode(ByVal axis As Int16, ByVal mode As Int16, ByVal EZ_count As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_home_mode(axis Mod 6, mode, EZ_count)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub HomeMove(ByVal axis As Int16, ByVal home_mode As Int16, ByVal vel_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).home_move(axis Mod 6, home_mode, vel_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub DecelStop(ByVal axis As Int16, ByVal Tdec As Double)
        ...
        mMust.WaitOne()
        Try
            Mt(i).decel_stop(axis Mod 6, Tdec)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetPosition(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).get_plan_pos(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetPosition(ByVal axis As Int16, ByVal current_position As Integer)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_position(axis Mod 6, current_position)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetCheckDone(ByVal axis As Int16) As Int16
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).check_done(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetIoStatus(ByVal axis As Int16) As Long
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).axis_io_status(axis Mod 6)
    ...
    Public Overrides Function GetAxisStatus(ByVal axis As Int16) As Int16
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).axis_status(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetRsts(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).get_rsts(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub TPmove(ByVal axis As Int16, ByVal Dist As Int32, ByVal posi_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).t_pmove(axis Mod 6, Dist, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ExTPmove(ByVal axis As Int16, ByVal Dist As Int32, ByVal posi_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).ex_t_pmove(axis Mod 7, Dist, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SPmove(ByVal axis As Int16, ByVal Dist As Int32, ByVal posi_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).s_pmove(axis Mod 7, Dist, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ExSPmove(ByVal axis As Int16, ByVal Dist As Int32, ByVal posi_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).ex_s_pmove(axis Mod 6, Dist, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub VarietySpeed(ByVal axis As Int16, ByVal chg_enable As Int16, ByVal Max_Vel As Double)
        ...
        mMust.WaitOne()
        Try
            Mt(i).variety_speed_range(axis Mod 6, chg_enable, Max_Vel)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function ReadCurrentSpeed(ByVal axis As Int16) As Double
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).read_current_speed(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ChangeSpeed(ByVal axis As Int16, ByVal Curr_Vel As Double)
        ...
        mMust.WaitOne()
        Try
            Mt(i).change_speed(axis Mod 6, Curr_Vel)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetVectorProfile(ByVal Min_Vel As Double, ByVal Max_Vel As Double, ByVal Tacc As Double, ByVal Tdec As Double)
        ...
        Try
            For i As Short = 0 To ip.Length - 1
                Mt(i).set_vector_profile(Min_Vel, Max_Vel, Tacc, Tdec)
            Next
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
    ...
    Public Overrides Sub SetProfile(ByVal axis As Int16, ByVal Min_Vel As Double, ByVal Max_Vel As Double, ByVal Tacc As Double, ByVal Tdec As Double)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_profile(axis Mod 6, Min_Vel, Max_Vel, Tacc, Tdec)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetSProfile(ByVal axis As Int16, ByVal Min_Vel As Double, ByVal Max_Vel As Double, ByVal Tacc As Double, ByVal Tdec As Double, ByVal Sacc As Int32, ByVal Sdec As Int32)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_s_profile(axis Mod 6, Min_Vel, Max_Vel, Tacc, Tdec, Sacc, Sdec)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetSTProfile(ByVal axis As Int16, ByVal Min_Vel As Double, ByVal Max_Vel As Double, ByVal Tacc As Double, ByVal Tdec As Double)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_st_profile(axis Mod 6, Min_Vel, Max_Vel, Tacc, Tdec, Tacc / 3, Tdec / 3)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ResetTargetPosition(ByVal axis As Int16, ByVal Dist As Int32)
        ...
        mMust.WaitOne()
        Try
            Mt(i).reset_target_position(axis Mod (i), Dist)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub Line2(ByVal AXIS1 As Int16, ByVal Dist1 As Int32, ByVal AXIS2 As Int16, ByVal Dist2 As Int32, ByVal posi_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).t_line2(AXIS1 Mod 6, Dist1, AXIS2 Mod 6, Dist2, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub Line3(ByVal axis As ArrayList, ByVal Dist1 As Int32, ByVal Dist2 As Int32, ByVal Dist3 As Int32, ByVal posi_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).t_line3(axis, Dist1, Dist2, Dist3, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub Line4(ByVal cardno As Int16, ByVal Dist1 As Int32, ByVal Dist2 As Int32, ByVal Dist3 As Int32, ByVal Dist4 As Int32, ByVal posi_mode As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).t_line4(cardno, Dist1, Dist2, Dist3, Dist4, posi_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ArcMove(ByVal axis As ArrayList, ByVal target_pos As ArrayList, ByVal cen_pos As ArrayList, ByVal arc_dir As Short)
        ...
        mMust.WaitOne()
        Try
            Mt(i).arc_move(axis, target_pos, cen_pos, arc_dir)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub relArcMove(ByVal axis As ArrayList, ByVal target_pos As ArrayList, ByVal cen_pos As ArrayList, ByVal arc_dir As Short)
        ...
        mMust.WaitOne()
        Try
            Mt(i).rel_arc_move(axis, target_pos, cen_pos, arc_dir)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetHandwheelInmode(ByVal axis As Int16, ByVal inmode As Int16, ByVal count_dir As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_handwheel_inmode(axis Mod 6, inmode, count_dir)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub HandwheelMove(ByVal axis As Int16, ByVal vh As Double)
        ...
        mMust.WaitOne()
        Try
            Mt(i).handwheel_move(axis Mod 6, vh)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetEncoder(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).get_encoder(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetEncode(ByVal axis As Int16, ByVal encoder_value As Int32)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_encoder(axis Mod 6, encoder_value)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub CounterConfig(ByVal axis As Int16, ByVal mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).counter_config(axis Mod 6, mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigLTC(ByVal axis As Int16, ByVal ltc_logic As Int16, ByVal ltc_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_LTC_PIN(axis Mod 6, ltc_logic, ltc_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetLatchValue(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).get_latch_value(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetLatchFlag(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).get_latch_flag(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ResetLatchFlag(ByVal cardno As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).reset_latch_flag(cardno)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetCounterFlag(ByVal cardno As Int16) As Int32
        mMust.WaitOne()
        Try
            Return Mt(cardno).get_counter_flag(cardno)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ResetCounterFlag(ByVal cardno As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).reset_counter_flag(cardno)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ResetClearFlag(ByVal cardno As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).reset_clear_flag(cardno)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub Config_EZ(ByVal axis As Int16, ByVal ez_logic As Int16, ByVal ez_mode As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_EZ_PIN(axis Mod 6, ez_logic, ez_mode)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigLatchMode(ByVal cardno As Int16, ByVal all_enable As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).config_latch_mode(cardno, all_enable)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub TrigerChunnel(ByVal cardno As Int16, ByVal num As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).triger_chunnel(cardno, num)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetSpeakerLogic(ByVal cardno As Int16, ByVal logic As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).set_speaker_logic(cardno, logic)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigEMG(ByVal cardno As Int16, ByVal enable As Int16, ByVal emg_logic As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).config_EMG_PIN(cardno, enable, emg_logic)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigLTCFilter(ByVal cardno As Int16, ByVal width As Int16, ByVal enable As Int16)
        mMust.WaitOne()
        Try
            Mt(cardno).config_LTC_filter(cardno, width, enable)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigEncoderFilter(ByVal axis As Int16, ByVal width As Int16, ByVal enable As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_encoder_filter(axis Mod 6, width, enable)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function ReadCMP(ByVal axis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).read_CMP_PIN(axis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub WriteCMP(ByVal axis As Int16, ByVal on_off As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).write_CMP_PIN(axis Mod 6, on_off)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigCMP(ByVal axis As Int16, ByVal cmp1_enable As Int16, ByVal cmp2_enable As Int16, ByVal CMP_logic As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_CMP_PIN(axis Mod 6, cmp1_enable, cmp2_enable, CMP_logic)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ConfigComparator(ByVal axis As Int16, ByVal cmp1_condition As Int16, ByVal cmp2_condition As Int16, ByVal source_sel As Int16, ByVal SL_action As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).config_comparator(axis Mod 6, cmp1_condition, cmp2_condition, source_sel, SL_action)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub SetComparatorData(ByVal axis As Int16, ByVal cmp1_data As Int32, ByVal cmp2_data As Int32)
        ...
        mMust.WaitOne()
        Try
            Mt(i).set_comparator_data(axis Mod 6, cmp1_data, cmp2_data)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function GetEquiv(ByVal axis As Int16, ByRef equiv As Double) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).get_equiv(axis Mod 6, equiv)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function SetEquiv(ByVal axis As Int16, ByVal new_equiv As Double) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).set_equiv(axis Mod 6, new_equiv)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub ArcMoveUnitmm(ByRef axis As Int16, ByRef target_pos As Double, ByRef cen_pos As Double, ByVal arc_dir As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).arc_move_unitmm(axis Mod 6, target_pos, cen_pos, arc_dir)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Sub RelArcMoveUnitmm(ByRef axis As Int16, ByRef rel_pos As Double, ByRef rel_cen As Double, ByVal arc_dir As Int16)
        ...
        mMust.WaitOne()
        Try
            Mt(i).rel_arc_move_unitmm(axis Mod 6, rel_pos, rel_cen, arc_dir)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function SetTMoveAll(ByVal TotalAxes As Int16, ByRef pAxis As Int16, ByRef pDist As Int32, ByVal posi_mode As Int16) As Int32
        ...
        Try
            For i As Short = 0 To ip.Length - 1
                Return Mt(i).set_t_move_all(TotalAxes, pAxis, pDist, posi_mode)
            Next
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
    ...
    Public Overrides Function StartMoveAll(ByVal FirstAxis As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).start_move_all(FirstAxis Mod 6)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function SetSyncOption(ByVal axis As Int16, ByVal sync_stop_on As Int16, ByVal cstop_output_on As Int16, ByVal sync_option1 As Int16, ByVal sync_option2 As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).set_sync_option(axis Mod 6, sync_stop_on, cstop_output_on, sync_option1, sync_option2)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
    ...
    Public Overrides Function SetSyncStopMode(ByVal axis As Int16, ByVal stop_mode As Int16) As Int32
        ...
        mMust.WaitOne()
        Try
            Return Mt(i).set_sync_stop_mode(axis Mod 6, stop_mode)
        Catch ex As Exception
