...
#Region "declareDMC5000"
    ...
    ''' <param name="el_logic">有效电平：0-低电平，1-高电平,2-正低负高有效，3-负低正高有效</param>
...
#End Region
    ...
    Private Sub SplitAxisNum(ByRef CardNo As Int16, ByRef AxisNum As Int16)
        If AxisNum <= 7 Then
            CardNo = 0
        ElseIf AxisNum > 7 And AxisNum <= 15 Then
            CardNo = 1
            AxisNum -= 8
        ElseIf AxisNum > 15 Then
            CardNo = 2
            AxisNum -= 16
        End If
    End Sub
    ...
    Public Overrides Sub INP(ByVal axis As Int16, ByVal enable As Int16, ByVal inp_logic As Int16)
        ...
        Try
            ...
            If ini_i <> 0 Then
                ' Throw New Exception("设置到位信息信息错误！错误信息为：" & ini_i)
                Throw New AppException("404051", XX设置到位信息信息错误_错误信息为 & ini_i)
            End If
        Catch ex As AppException
            Throw ex
        Catch ex As Exception
...
A:
    ...
    Public Overrides Sub Config_EZ(ByVal axis As Int16, ByVal ez_logic As Int16, ByVal ez_mode As Int16)
        ...
        Try
            ...
            If ini_i <> 0 Then
                ' Throw New Exception("设置编码器函数函数错误！错误信息为：" & ini_i)
                Throw New AppException("404082", XX设置EZ信号函数错误_错误信息为 & ini_i)
            End If
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
