Public Class _2410Base
    ...
    '单轴定长运动
    Private Declare Sub d2410_t_pmove Lib "DMC2410.dll" (ByVal axis As Int16, ByVal Dist As Int32, ByVal posi_mode As Int16)
    ...
    Private Declare Sub d2410_t_line3 Lib "DMC2410.dll" (ByVal axis As ArrayList, ByVal Dist1 As Int32, ByVal Dist2 As Int32, ByVal Dist3 As Int32, ByVal posi_mode As Int16)
    ...
    '圆弧插补
    Private Declare Sub d2410_arc_move Lib "DMC2410.dll" (ByVal axis As ArrayList, ByVal target_pos As ArrayList, ByVal cen_pos As ArrayList, ByVal arc_dir As Short)
    Private Declare Sub d2410_rel_arc_move Lib "DMC2410.dll" (ByVal axis As ArrayList, ByVal rel_pos As ArrayList, ByVal rel_pos As ArrayList, ByVal arc_dir As Short)
...
#Region "底层函数"
    ...
    Public Overrides Sub ELMODE(ByVal axis As Int16, ByVal el_mode As Int16)
        mMust.WaitOne()
        Try
            If el_mode = 0 Then '低有效
                d2410_config_EL_MODE(axis, 0)
            Else '高有效
                d2410_config_EL_MODE(axis, 2)
            End If
    ...
    Public Overrides Function GetCheckDone(ByVal axis As Int16) As Int16
        mMust.WaitOne()
        Try
            Dim i As Short = d2410_check_done(8)
            Return d2410_check_done(axis)
            'If d2410_read_inbit(0, 9) = 0 Then
            '    Return 1
            'ElseIf d2410_read_inbit(0, 9) = 1 Then
            '    Return 0
            'End If
            ...
            'Select Case axis
            '    Case 0
            '        If d2410_read_inbit(0, 11) = 1 Then
            '            Return 0
            '        Else
            '            Return 1
            '        End If
            '    Case 1
            '        If d2410_read_inbit(0, 12) = 1 Then
            '            Return 0
            '        Else
            '            Return 1
            '        End If
            '    Case 2
            '        If d2410_read_inbit(0, 13) = 1 Then
            '            Return 0
            '        Else
            '            Return 1
            '        End If
            '    Case 3
            '        If d2410_read_inbit(0, 14) = 1 Then
            '            Return 0
            '        Else
            '            Return 1
            '        End If
            '    Case 4
            '        If d2410_read_inbit(0, 15) = 1 Then
            '            Return 0
            '        Else
            '            Return 1
            '        End If
            '    Case 5
            '        If d2410_read_inbit(0, 16) = 1 Then
            '            Return 0
            '        Else
            '            Return 1
            '        End If
    ...
    Public Overrides Sub SetSTProfile(ByVal axis As Int16, ByVal Min_Vel As Double, ByVal Max_Vel As Double, ByVal Tacc As Double, ByVal Tdec As Double)
        mMust.WaitOne()
        Try
            d2410_set_st_profile(axis, Min_Vel, Max_Vel, Tacc, Tdec, Tacc / 3, Tdec / 3)
        Catch ex As Exception
        Finally
            mMust.ReleaseMutex()
        End Try
